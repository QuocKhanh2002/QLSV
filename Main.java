...
public class Main {
    ...
    private static void SortNameSinhVien() {
        ...
        Collections.sort(SinhVienList , new SapXepSVTheoTen());
    }

    
     private static void GPASinhVien()
     {
         Collections.sort(SinhVienList, new SapXepSVTheoGPA());
     }

//    public static SapXepSVTheoTen im Comparator<SinhVien>  {
//    @Override
